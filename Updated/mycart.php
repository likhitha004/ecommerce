	...
	<div style="margin-top: 20px; padding: 0 10%;">
		...
		$result = mysqli_query($con, "SELECT * FROM user WHERE id='$user'");
			$get_user_email = mysqli_fetch_assoc($result);
				...
				echo '<h3 style="color:#169E8F;font-size:35px;"> Total: Rs '.$_SESSION['total'].' Rs</h2>';
								...
								<form action="" method="POST" class="registration">
									...
									<div class="signup_form" >
										...
										Types of Delivery <br>
										 ...
										 <input name="Delivery" required="required" value="Express Delivery +100rs upon cash on delivery" type="radio"  placeholder="Mode Of Payment"> Express Delivery </br>
										...
										<div>
											<input onclick="myFunction()" name="order" class="uisignupbutton signupbutton" type="submit" value="Cash on Delivery">
										</div>
