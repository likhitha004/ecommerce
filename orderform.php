...
if (isset($_REQUEST['poid'])) {
	...
	$poid = mysqli_real_escape_string($connect,$_REQUEST['poid']);
}else {
...
$getposts = mysqli_query($connect,"SELECT * FROM products WHERE id ='$poid'") or die(mysql_error());
...
//triming name
	try {
		...
		// Check if email already exists
						...
						if(mysqli_query($connect,"INSERT INTO orders (uid,pid,quantity,oplace,mobile,odate,ddate) VALUES ('$user','$poid',$quan,'$_POST[address]','$_POST[mobile]','$d','$date')")){
	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="women/hijab.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #c7587e;border-radius: 12px;">Kurthi</a></th>
			...
			<div>
				...
				<?php 
					...
					echo '
						...
						<div>
							<form action="payments.php" method="POST" class="registration">
								<div class="signup_form" style="    margin-top: 38px;">
									...
									<div>
										...
										<div>
										<td>
										<input name="email" placeholder="Your email" required="required" class="email signupbox" type="text" size="30" value="'.$uemail_db.'">
									</td>
									</div>
									<div>
									<td>
											<input name="price" placeholder="price" required="required" class="email signupbox" type="text" size="30" value="'.$price.'">
										</td>
									</div>
									<div>
										<td>
				 ...
				 ?><?php
									...
									<div>
										<input name="order" class="uisignupbutton signupbutton" type="submit" value="Pay with Card">
									</div>
				 ...
				 ?><?php
									...
									<div>
										<input name="order" class="uisignupbutton signupbutton" type="submit" value="Cash On Delivery">
									</div>
									<div class="signup_error_msg"> '; ?>
